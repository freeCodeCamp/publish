...
export interface ApiInvitedUserInvitedUser extends Schema.CollectionType {
  collectionName: 'invited_users';
  info: {
    singularName: 'invited-user';
    pluralName: 'invited-users';
...
export interface ApiTagTag extends Schema.CollectionType {
  ...
  attributes: {
    ...
    visibility: Attribute.Enumeration<['public', 'internal']> &
      Attribute.Required &
...
export interface PluginUsersPermissionsRole extends Schema.CollectionType {
  ...
  attributes: {
    ...
    users: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    invited_users: Attribute.Relation<
      'plugin::users-permissions.role',
      'oneToMany',
      'api::invited-user.invited-user'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::invited-user.invited-user': ApiInvitedUserInvitedUser;
